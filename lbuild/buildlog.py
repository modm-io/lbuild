...
class BuildLog:
    ...
    def log(self, module, filename_in: str, filename_out: str, time=None):
        ...
        Checks wether an operation would overwrite a file a file previously generated by another
        module and raises a build exception in that case.

        Args:
            module: Module which generates the module.
            filename_in: Template from which the file is generated. If it is a relative path,
                it is combined with the module path.
            filename_out: Path of the generated file. A relative path is combined with the output
                path set in the constructor of the buildlog.
